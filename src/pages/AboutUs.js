        ...
        <section className="section why-penn">
          ...
          <div className="why-penn-content">
            <div className="why-penn-item">
              <img className="bullet-icon" src={BulletIcon1} alt="Bullet Icon 1" />
            ...
            <div className="why-penn-item">
              <img className="bullet-icon" src={BulletIcon2} alt="Bullet Icon 2" />
            ...
            <div className="why-penn-item">
              <img className="bullet-icon" src={BulletIcon3} alt="Bullet Icon 3" />
            ...
            <div className="why-penn-item">
              <img className="bullet-icon" src={BulletIcon4} alt="Bullet Icon 4" />
